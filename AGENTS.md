...
settings should be partitioned by category with one file being dedicated to values a typical user may wish to change themselves, and several to various categories of persistent storage
