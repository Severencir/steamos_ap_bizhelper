...
STATE_SETTINGS_DEFAULTS = {
    ...
    BIZHAWK_LAST_PID_KEY: "",
    BIZHAWK_MIGRATION_PID_KEY: "",
    DEBUG_DOWNLOAD_CACHE_KEY: False,
    PENDING_RELAUNCH_ARGS_KEY: [],
    ROM_HASH_CACHE_KEY: {},
    STEAM_APPID_KEY: "",
...
SAFE_SETTINGS_DEFAULTS = {
    ...
    BIZHAWK_RUNNER_TRANSIENT_SERVICE_KEY: True,
}
...
SAFE_SETTINGS_KEYS = [
    ...
    "KIVY_DIALOG_WIDTH",
    "KIVY_DIALOG_HEIGHT",
    "KIVY_DIALOG_MIN_WIDTH",
    "KIVY_DIALOG_MIN_HEIGHT",
    "KIVY_DIALOG_RESIZABLE",
    "KIVY_DIALOG_BORDERLESS",
    "KIVY_DIALOG_PADDING_DP",
    "KIVY_DIALOG_SPACING_DP",
    "KIVY_BUTTON_HEIGHT_DP",
    "KIVY_LIST_ROW_HEIGHT_DP",
    "KIVY_FILE_DIALOG_HEIGHT",
    "KIVY_BG_RGBA",
    "KIVY_FOCUS_RGBA",
    AP_DESKTOP_SHORTCUT_KEY,
    AP_TRANSIENT_SERVICE_KEY,
