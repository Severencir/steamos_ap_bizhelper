...
PATH_SETTINGS_DEFAULTS = {
    ...
    SAVE_MIGRATION_HELPER_PATH_KEY: str(APP_COMPONENTS_SRC_DIR / SAVE_HELPER_STAGED_FILENAME),
...
INSTALL_STATE_DEFAULTS = {
    ...
    BIZHAWK_ENTRY_LUA_PATH_KEY: str(APP_COMPONENTS_SRC_DIR / BIZHAWK_ENTRY_LUA_FILENAME),
}
